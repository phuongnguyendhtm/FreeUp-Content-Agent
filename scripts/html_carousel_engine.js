    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            body { margin: 0; background-color: #F5F7F6; color: #ffffff; font-family: var(--font-primary); display: flex; flex-direction: column; width: 1080px; height: 1080px; overflow: hidden; }
            ...
            main { position: absolute; top: 0; left: 0; width: 1080px; height: 1080px; display: flex; flex-direction: column; overflow: hidden; background-color: #F5F7F6; z-index: 1; }
