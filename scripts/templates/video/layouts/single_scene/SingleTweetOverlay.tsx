...
export const SingleTweetOverlay: React.FC<{ scene: any }> = ({ scene }) => {
    ...
    const brandHandle = scene.brand_handle || brandConfig.brand_identity?.handle || '@freeup';
    const brandName = scene.brand_name || brandConfig.founder || 'Nguyễn Thị Việt Phương';
