# 🏁 FreeUp Content Agent: Tổng Hướng Dẫn Vận Hành & Thiết Lập

Chào mừng bạn đến với hệ thống **FreeUp Content Agent**. Đây là tài liệu duy nhất bạn cần để làm chủ "Dây chuyền sản xuất nội dung" tự động của mình.
...
Dựa trên Insight đã nghiên cứu, Agent Copywriter sẽ viết ra các nội dung "Master Content" chuẩn công thức FreeUp (PAS, Hook tam đoạn). Đây là nền tảng để biến hóa thành Video, Carousel hay Infographic.
...
2.  Đặt tên cho file (Ví dụ: `FreeUp Content Agency Dashboard`).
